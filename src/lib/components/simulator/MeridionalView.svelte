...
<div class="view-wrap">
  <div class="view-label">
    <div class="view-label-header">
      <h3>Side Cross-Section</h3>
      <HelpIcon text="This shows a vertical slice through the middle. You can see the different layers: the rotating matter ring (white), the coupling zone (gold), and the exotic matter shell (red)." />
    </div>
    <p>Layers inside the structure</p>
  </div>
